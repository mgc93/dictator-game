...
generateExchangeRates = function(randIndexTrial){
    ...
    // ];
    var vs_block = [1, 1, 1, 1, 1, 1, 1];
    var vo_block = [1, 2, 3, 4, 0.5, 0.33, 0.25];
    var er_block = [1, 2, 3, 4, 0.5, 0.33, 0.25];
    var er_block_bottom = [0.83, 1.67, 2.5, 3.33, 0.42, 0.27, 0.21];
    var er_block_top = [1.25, 2.50, 3.75, 5.00, 0.62, 0.41, 0.31];
    var er_block_trial_exchange_rate = [
        [1.128, 1.038, 1.183, 1.098, 1.198, 0.843, 1.163, 0.943, 1.218, 1.018, 0.838, 1.153, 1.108, 0.948, 1.058, 0.898, 1.003, 1.233, 1.143, 1.068],
        [2.447, 2.492, 2.237, 2.452, 2.027, 2.267, 1.712, 1.902, 1.682, 1.792, 2.302, 2.037, 2.202, 1.782, 1.742, 2.062, 1.822, 1.727, 2.432, 2.122],
        [2.925, 2.955, 2.555, 2.985, 3.565, 2.980, 2.715, 2.625, 2.765, 3.535, 2.550, 3.475, 3.160, 3.020, 3.715, 3.110, 3.330, 3.630, 2.950, 3.610],
        [4.378, 4.008, 3.683, 3.688, 4.538, 3.458, 4.033, 4.453, 3.333, 4.288, 3.743, 3.918, 3.378, 4.573, 3.448, 3.788, 3.983, 4.013, 3.723, 4.783],
        [0.557, 0.562, 0.437, 0.572, 0.497, 0.517, 0.537, 0.607, 0.622, 0.567, 0.527, 0.547, 0.512, 0.592, 0.442, 0.577, 0.452, 0.447, 0.597, 0.602],
        [0.290, 0.320, 0.345, 0.405, 0.355, 0.370, 0.340, 0.285, 0.305, 0.330, 0.400, 0.335, 0.300, 0.365, 0.390, 0.310, 0.350, 0.375, 0.360, 0.395],
        [0.258, 0.273, 0.253, 0.223, 0.278, 0.263, 0.248, 0.208, 0.308, 0.228, 0.283, 0.293, 0.288, 0.303, 0.268, 0.218, 0.298, 0.213, 0.233, 0.238]
    ];
