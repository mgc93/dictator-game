...
jsPsych.plugins['survey-likert-slider'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'survey-likert-slider',
    description: '',
    parameters: {
      questions: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      html += '<input type="range" name="Q' + question_order[i] + '" value="'+trial.slider_start+'" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" style="width: 100%;" id="jspsych-html-slider-response-response"></input>';
